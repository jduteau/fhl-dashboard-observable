import { readCsvFile, statsData, rosterPeriods, availablePeriods, mapPosition, calculateAge, getStatsForPeriod } from "../components/loadfiles.js";
...
const teamData = teamInfo.map(team => {
  ...
  const currentStats = statsData[lastPeriodNum];
